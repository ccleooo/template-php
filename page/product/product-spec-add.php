                    ...
                    <div class="row">
                        <div class="col-10 mx-auto user">
                            ...
                            <div class="content shadow">
                                <form action="product-spec-doInsert.php" method="post">
                                    <table class="table table-bordered mt-3">
                                        <tbody>
                                            <tr>
                                                <td class="w-20 bg_gray">商品規格</td>
                                                <td>
                                                    <input type="text" class="form-control" name="name" id="name">
                                                </td>
                                            </tr>
                                            <tr>
                                                <td class="w-20 bg_gray">規格說明</td>
                                                <td>
                                    ...
                                    <div class="text-center mt-4">
                                        <button class="btn btn-primary" type="submit">新增規格</button>
                                    </div>
                                </form>
                            </div>
                        </div>
